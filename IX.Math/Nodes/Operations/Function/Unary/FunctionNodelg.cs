// <copyright file="FunctionNodelg.cs" company="Adrian Mos">
...
namespace IX.Math.Nodes.Operations.Function.Unary
{
    ...
    internal sealed class FunctionNodelg : UnaryFunctionNodeBase
    {
        public FunctionNodelg(NumericNode parameter)
            : base(parameter)
        {
        }

        public FunctionNodelg(NumericParameterNode parameter)
            : base(parameter)
        {
        }

        public FunctionNodelg(UndefinedParameterNode parameter)
            : base(parameter?.DetermineNumeric())
        {
        }

        public FunctionNodelg(OperationNodeBase parameter)
