// <copyright file="FunctionNodeacos.cs" company="Adrian Mos">
...
namespace IX.Math.Nodes.Operations.Function.Unary
{
    ...
    internal sealed class FunctionNodeacos : UnaryFunctionNodeBase
    {
        public FunctionNodeacos(NumericNode parameter)
            : base(parameter)
        {
        }

        public FunctionNodeacos(NumericParameterNode parameter)
            : base(parameter)
        {
        }

        public FunctionNodeacos(UndefinedParameterNode parameter)
            : base(parameter?.DetermineNumeric())
        {
        }

        public FunctionNodeacos(OperationNodeBase parameter)
