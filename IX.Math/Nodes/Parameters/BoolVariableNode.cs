// <copyright file="BoolVariableNode.cs" company="Adrian Mos">
...
namespace IX.Math.Nodes.Parameters
{
    ...
    public class BoolVariableNode : BoolParameterNode, IVariableNode
    {
        ...
        internal BoolVariableNode(string variableName, NodeBase referenceNode)
            : base(variableName)
        {
        ...
        public ParameterExpression GenerateVariableExpression()
        {
            ...
            {
                this.cachedVariableExpression = Expression.Variable(typeof(bool), this.Name);
            }
