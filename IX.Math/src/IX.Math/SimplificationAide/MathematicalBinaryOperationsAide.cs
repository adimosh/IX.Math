...
namespace IX.Math.SimplificationAide
{
    ...
    public static class MathematicalBinaryOperationsAide
    {
        ...
        /// <param name="right">The right operand.</param>
        /// <returns>The result.</returns>
        public static char Subtract(char left, char right)
        {
            return (char)(left - right);
        }
        ...
        /// <param name="right">The right operand.</param>
        /// <returns>The result.</returns>
        public static char Divide(char left, char right)
        {
            return (char)(left / right);
        }
        ...
        {
            return (byte)(left << (int)Convert.ChangeType(right, typeof(int)));
        }
        ...
        {
            return (sbyte)(left << (int)Convert.ChangeType(right, typeof(int)));
        }
        ...
        {
            return (short)(left << (int)Convert.ChangeType(right, typeof(int)));
        }
        ...
        {
            return (ushort)(left << (int)Convert.ChangeType(right, typeof(int)));
        }
        ...
        /// <param name="right">The right operand.</param>
        /// <returns>The result.</returns>
        public static char LeftShift(char left, char right)
        {
            return (char)(left << (int)Convert.ChangeType(right, typeof(int)));
        }
        ...
        /// <param name="right">The right operand.</param>
        /// <returns>The result.</returns>
        public static char RightShift(char left, char right)
        {
            return (char)(left >> (int)Convert.ChangeType(right, typeof(int)));
        }
        ...
        /// <param name="right">The right operand.</param>
        /// <returns>The result.</returns>
        public static char And(char left, char right)
        {
            return (char)(left & right);
        }
        ...
        /// <param name="right">The right operand.</param>
        /// <returns>The result.</returns>
        public static char Or(char left, char right)
        {
            return (char)(left | right);
        }
        ...
        /// <param name="right">The right operand.</param>
        /// <returns>The result.</returns>
        public static sbyte Xor(sbyte left, sbyte right)
        {
            return (sbyte)(left ^ right);
        }
        ...
        /// <param name="right">The right operand.</param>
        /// <returns>The result.</returns>
        public static ushort Xor(ushort left, ushort right)
        {
            return (ushort)(left ^ right);
        }
        ...
        /// <param name="right">The right operand.</param>
        /// <returns>The result.</returns>
        public static char Xor(char left, char right)
        {
            return (char)(left ^ right);
        }
