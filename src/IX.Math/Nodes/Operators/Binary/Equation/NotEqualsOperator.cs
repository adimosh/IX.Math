// <copyright file="NotEqualsOperator.cs" company="Adrian Mos">
...
{
    /// <summary>
    /// A not equals binary operator.
    /// </summary>
    internal sealed class NotEqualsOperator : EquationNodeBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotEqualsOperator"/> class.
        /// </summary>
        /// <param name="leftOperand">The left operand.</param>
        /// <param name="rightOperand">The right operand.</param>
        internal NotEqualsOperator(
