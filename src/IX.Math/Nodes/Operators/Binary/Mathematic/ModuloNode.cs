...
{
    /// <summary>
    ///     A node for a modulo operation.
    /// </summary>
    /// <seealso cref="SimpleMathematicalOperationNodeBase" />
    [DebuggerDisplay("{" + nameof(Left) + "} / {" + nameof(Right) + "}")]
    internal sealed class ModuloNode : SimpleMathematicalOperationNodeBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModuloNode" /> class.
        /// </summary>
