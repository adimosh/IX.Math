...
#region Methods
        ...
        public sealed override NodeBase Simplify()
        {
            ...
            if (left.TryGetBinary(out byte[] bavl) && right.TryGetBinary(out byte[] bavr))
            {
            ...
            if (left.TryGetString(out string svl) && right.TryGetString(out string svr))
            {
                var bli = left.CheckSupportedType(SupportableValueType.Integer);
                var bln = left.CheckSupportedType(SupportableValueType.Numeric);
                var bri = right.CheckSupportedType(SupportableValueType.Integer);
            ...
            in ComparisonTolerance comparisonTolerance)
        {
            try
            {
                (var leftExpression, var rightExpression, SupportedValueType internalType) =
...
#region Strings
                    ...
                    case SupportedValueType.String:
                    {
                        ...
                        MethodCallExpression? leftOperand = Expression.Call(
                            mi,
                            leftExpression,
                            rightExpression,
                            Expression.Constant(
                        ...
                        ConstantExpression? rightOperand = Expression.Constant(
                            0,
                            typeof(int));
...
#region Booleans
                    ...
                    {
                        BinaryExpression? testExpression = Expression.Equal(
                            leftExpression,
                            Expression.Constant(
                                true,
                                typeof(bool)));
...
#region Byte arrays
                    ...
                    {
                        MethodInfo? mi = typeof(ArrayExtensions).GetMethodWithExactParameters(
...
#region Numbers
                    ...
                    case SupportedValueType.Numeric:
                    {
                        ...
                        {
                            Expression? possibleTolerantExpression = this.PossibleToleranceExpression(
                                leftExpression,
                                rightExpression,
                                ...
                                switch ((lessThanLocal, equalsLocal))
                                {
                                    ...
                                    case (true, false):
                                        toleranceExpression = Expression.Constant(
                                            ...
                                            typeof(long));
                                        methodInfo = numericExp.Type == typeof(long)
                                            ? ((Func<string, long, long, bool>)LessThanIntegerToleranceRangeInteger)
                                            .Method
                                            : ((Func<string, double, long, bool>)LessThanIntegerToleranceRangeNumeric)
                                            .Method;
                                    ...
                                    case (false, false):
                                        toleranceExpression = Expression.Constant(
                                            ...
                                            typeof(long));
                                        methodInfo = numericExp.Type == typeof(long)
                                            ? ((Func<string, long, long, bool>)GreaterThanIntegerToleranceRangeInteger)
                                            .Method
                                            : ((Func<string, double, long, bool>)GreaterThanIntegerToleranceRangeNumeric
                                            ).Method;
                                ...
                                switch ((lessThanLocal, equalsLocal))
                                {
                                    ...
                                    case (true, false):
                                        toleranceExpression = Expression.Constant(
                                            ...
                                            typeof(double));
                                        methodInfo = numericExp.Type == typeof(long)
                                            ? ((Func<string, long, double, bool>)LessThanNumericToleranceRangeInteger)
                                            .Method
                                            : ((Func<string, double, double, bool>)LessThanNumericToleranceRangeNumeric)
                                            .Method;
                                    ...
                                    case (false, false):
                                        toleranceExpression = Expression.Constant(
                                            ...
                                            typeof(double));
                                        methodInfo = numericExp.Type == typeof(long)
                                            ? ((Func<string, long, double, bool>)GreaterThanNumericToleranceRangeInteger
                                            ).Method
                                            : ((Func<string, double, double, bool>)
...
#region Proportion and percentage tolerance
                            ...
                            if (tolerance.ProportionalTolerance != null)
                            {
                                ...
                                if (proportionalOrPercentageTolerance < 1D && proportionalOrPercentageTolerance > 0D)
                                {
                                    ...
                                    switch ((lessThanLocal, equalsLocal))
                                    {
                                        ...
                                        case (true, false):
                                            methodInfo = numericExp.Type == typeof(long)
                                                ? ((Func<string, long, double, bool>)LessThanPercentageToleranceInteger)
                                                .Method
                                                : ((Func<string, double, double, bool>)
