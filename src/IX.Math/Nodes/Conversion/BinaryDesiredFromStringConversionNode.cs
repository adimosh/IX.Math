...
#region Constructors
        ...
        public BinaryDesiredFromStringConversionNode([NotNull] NodeBase sourceNode)
            : base(
                sourceNode,
...
#region Methods
        ...
        public override NodeBase DeepClone(NodeCloningContext context) =>
            new BinaryDesiredFromStringConversionNode(this.ConvertFromNode.DeepClone(context));
