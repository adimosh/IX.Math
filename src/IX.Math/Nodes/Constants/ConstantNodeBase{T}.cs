...
#region Constructors
        ...
        protected private ConstantNodeBase(T value)
        {
            ...
            List<SupportedValueType>? possibleReturns = GetSupportedTypeOptions(this.PossibleReturnType);
...
#region Methods
        ...
        /// </returns>
        protected virtual SupportableValueType GetSupportedTypes(T value) =>
            GetSupportableConversions(typeof(T));
