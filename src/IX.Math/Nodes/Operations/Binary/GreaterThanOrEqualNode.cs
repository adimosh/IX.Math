...
namespace IX.Math.Nodes.Operations.Binary
{
    ...
    {
        public GreaterThanOrEqualNode(NodeBase left, NodeBase right)
        ...
        public override NodeBase Simplify()
        {
            ...
            {
                return new BoolNode(bnLeft.Value ? true : !bnRight.Value);
            }
        ...
        public override NodeBase DeepClone(NodeCloningContext context) => new GreaterThanOrEqualNode(this.Left.DeepClone(context), this.Right.DeepClone(context));
