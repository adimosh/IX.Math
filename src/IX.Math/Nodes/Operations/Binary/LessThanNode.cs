...
namespace IX.Math.Nodes.Operations.Binary
{
    ...
    {
        public LessThanNode(NodeBase left, NodeBase right)
        ...
        public override NodeBase DeepClone(NodeCloningContext context) => new LessThanNode(this.Left.DeepClone(context), this.Right.DeepClone(context));
