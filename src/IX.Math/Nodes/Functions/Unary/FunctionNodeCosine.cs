...
namespace IX.Math.Nodes.Functions.Unary
{
    ...
    {
        private static readonly GlobalSystem.Func<double, double> CachedRepresentedFunction = GlobalSystem.Math.Cos;

        /// <summary>
        /// Initializes a new instance of the <see cref="FunctionNodeCosine" /> class.
        /// </summary>
        /// <param name="parameter">The parameter.</param>
        public FunctionNodeCosine(
            NodeBase parameter)
            : base(
                parameter)
        {
