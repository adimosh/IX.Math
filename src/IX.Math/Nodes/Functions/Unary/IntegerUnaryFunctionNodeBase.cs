...
#region Constructors
        ...
        protected IntegerUnaryFunctionNodeBase(NodeBase parameter)
            : base(parameter)
        {
        }
...
#region Properties and indexers
        ...
        /// </value>
        protected abstract Func<long, long> RepresentedFunction
        {
            get;
        }
...
#region Methods
        ...
        {
            if (this.Parameter is ConstantNodeBase fp && fp.TryGetInteger(out var first))
            {
                return (true, first);
            }
