// <copyright file="ComputedExpression.ObsoleteMethods.cs" company="Adrian Mos">
...
namespace IX.Math
{
    ...
    public partial class ComputedExpression
    {
        /// <summary>
        ...
        [Obsolete("This method is obsolete and should not be used anymore. Instead, use the methods in MathematicPortfolio.")]
