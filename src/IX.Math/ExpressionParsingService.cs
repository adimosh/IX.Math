...
namespace IX.Math
{
    ...
    [PublicAPI]
    internal sealed class ExpressionParsingService : DisposableBase, IExpressionParsingService
    {
        ...
        {
            Requires.NotNull(ref this.workingDefinition, definition, nameof(definition));
            ...
            CancellationToken cancellationToken = default)
        {
                    ...
                    this))
            {
                return new ComputedExpression(
                    expression,
                    new StringNode(this.stringFormatters, expression),
                    true,
                    new Dictionary<string, ExternalParameterNode>(),
                    this.stringFormatters);
            }

            bool ConstantPassThroughExtractorPredicate(
                Type cpteKey,
